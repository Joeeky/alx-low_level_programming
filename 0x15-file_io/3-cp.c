...
#include <stdio.h>
/**
 * close_errchk - Produce output and terminate a file descriptor
 * upon failure, generate an error message
 * @fd: The file handle to be terminated
...
/**
 * write_err - Mechanism for handling write error
 *
 * @fd1: The initial file descriptor to terminate
 * @fd2: The later file descriptor to terminate
 * @filename: The file name associated with error
 * Return: 99
 */
...
/**
 * read_err - Read error handling mechanism
 *
 * @fd1: The initial file descriptor to terminate
 * @fd2: The later file  descriptor to terminate
...
/**
 * main - Duplicate a file while setting the perms of the new file to 644
